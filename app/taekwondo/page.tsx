...
import TaekwondoBookingForm from '@/components/taekwondo/taekwondo-form'
  ...
  return (
    <main className="min-h-screen bg-[#F3F0EC] text-[#222222]">
      ...
      <section className="mx-auto max-w-2xl px-6 py-12 lg:py-16">
        ...
        <p className="text-xs uppercase tracking-[0.18em] text-[#E1A728]">Taekwondo</p>
        <h1 className="mt-4 font-serif text-5xl leading-[0.95] tracking-[-0.05em] text-[#1E5336] sm:text-6xl">
          Reserve the training floor.
        </h1>
        <p className="mt-5 max-w-xl text-sm leading-6 text-[#6B756B]">
          Book a taekwondo training floor by the hour for your class, clinic, or practice session at Rebar Sports Center.
        </p>
      </section>

      <section className="mx-auto max-w-2xl px-6 pb-16">
        <TaekwondoBookingForm onDone={() => router.push('/#facilities')} />
      </section>
    </main>
  )
}